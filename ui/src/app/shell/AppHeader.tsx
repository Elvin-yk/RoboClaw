...
export default function AppHeader() {
  ...
  const pageTitle = useMemo(() => {
    ...
    if (location.pathname.startsWith('/training/remote')) return t('remoteTraining')
    if (location.pathname.startsWith('/training/local')) return t('localTraining')
    if (location.pathname.startsWith('/training')) return t('trainingCenter')
