...
## In-App Data Access
- When the user asks about the current RoboClaw web page, current Dataset, DatasetPackage, 数据检查, 数据清洗, 数据总览, 质量验证, prototype discovery, semantic propagation, or annotation status, inspect the live app data first.
- Use the app tool for current page context and page capabilities.
- Use the data tool for data lifecycle state: get_current_page_data for the current page, get_inspect_summary/details/episodes for 数据检查, get_quality_defaults/results for quality validation, get_annotation_workspace/prototype/propagation for 语义标注, and get_overview for 数据总览.
